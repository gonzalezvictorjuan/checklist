...
module.exports = "<ion-list color=\"dark\">\n\n <!----> \n  <ion-item-sliding *ngFor=\"let lista of listasService.listas | filtroCompletado:_terminada\">\n  \n      <ion-item detail color=\"dark\" (click)=\"listaSeleccionada( lista )\">\n        <ion-label>\n          {{lista.titulo}}\n        </ion-label>\n        \n        <ion-note class=\"cantLista\" slot=\"end\" color=\"tertiary\">{{ lista.items.length }}</ion-note>\n      </ion-item>\n\n      <ion-item-options side=\"start\">\n        <ion-item-option (click)=\"editarLista( lista )\" color=\"primary\">\n          <ion-icon slot=\"icon-only\" name=\"create\"></ion-icon>\n        </ion-item-option>\n      </ion-item-options>\n\n      <ion-item-options side=\"end\">\n        <ion-item-option  (click)=\"borrarLista( lista )\" color=\"danger\">\n          <ion-icon slot=\"icon-only\" name=\"trash\"></ion-icon>\n        </ion-item-option>\n      </ion-item-options>\n \n  </ion-item-sliding>\n\n</ion-list>"
...
module.exports = ".cantLista {\n  padding: 2px 5px;\n  margin: 15px 0 7px 0;\n  background-color: white;\n  border-radius: 50px;\n  font-size: 12px;\n  font-weight: bold; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ListasComponent = /** @class */ (function () {
    function ListasComponent(listasService, router, alertController) {
                            ...
                            buttons: [
                                ...
                                },
                                {
                                    ...
                                    handler: function (data) {
                                        ...
                                        _this.listasService.guardarStorage();
                                        _this.lista.closeSlidingItems();
                                    }
                                }
                            ]
    ...
    ], ListasComponent.prototype, "_terminada", void 0);
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
var FiltroCompletadoPipe = /** @class */ (function () {
    ...
    FiltroCompletadoPipe.prototype.transform = function (listas, completado) {
        ...
        return listas.filter(function (lista) { return lista.terminada === completado; });
    };
...
var ListasService = /** @class */ (function () {
    ...
    ListasService.prototype.guardarStorage = function () {
        localStorage.setItem('data', JSON.stringify(this.listas));
    };
    ListasService.prototype.cargarStorage = function () {
